...
const data = [
  {
    ...
    url: "posts",
    btn: "شاهد مغاسل الرخام..",
    icon: "IoTabletLandscapeOutline",
    desc: "تفصيل مغاسل رخام فخمة بجودة عالية مع الخشب والمرايا بالإضافة للضمان لمدة خمس سنوات, بأيدي فنيين متخصصين في هذا المجال.",
  },
  {
    id: 2,
    title: " التصميم",
    ...
    btn: "شاهد التصاميم ",
    icon: "",
    desc: "تصميم مغاسل الرخام يعتمد بشكل كبير على ذوقك الشخصي وتفضيلاتك, لذا لا تتردد في البحث والإستشارة مع مصمم داخلي مختص بالرخام للحصول على أفضل تصميم.",
  },
  {
    id: 3,
    title: " توريد الرخام",
    url: "/posts/توريد-رخام",
    btn: "نصائح قبل توريد الرخام ",
    icon: "",
    desc: "  يتضمن عملية اختيار وتوفير الألواح المناسبة من الرخام الطبيعي  الحصول على أفضل شكل ممكن لمشروعك في التصميم الداخلي ,إذا كنت تخطط لتركيب الرخام لمشروعك ننصحك بالضغط على الزر أدناه ",
  },
  {
    id: 4,
    title: "تركيب الرخام",
    url: "/posts/تركيب-رخام",
    btn: "تركيب الرخام",
    icon: "",
    desc: "  يتضمن عملية اختيار وتوفير الألواح المناسبة من الرخام الطبيعي  الحصول على أفضل شكل ممكن لمشروعك في التصميم الداخلي ,إذا كنت تخطط لتركيب الرخام لمشروعك ننصحك بالضغط على الزر أدناه ",
  },
